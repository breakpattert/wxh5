...
<div class="container lineTop">
    ...
    <div @click="$router.push({ path:'/pages/busineshop/shop',query:{id:orderDetail?orderDetail.order.merchid:''}})" class="shopName lineBottom" >
        <div class="logo1" >
    ...
    <div>
       ...
       class="goods lineBottom clearfix">
        ...
        <div class="goods_detail_wrap">
            ...
            <div class="price">￥{{item.price/item.total}}</div>
            <div class="colorSize">
