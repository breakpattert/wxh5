              ...
              <swiper-item>
                ...
                <div id='item1' class="expressContent">
                    <div class="newAdress" @click="$router.push({ path:'/pages/user/myAdress'})">
                        <div class="add"> </div>
                        <div v-if="shopGoodsInfo&&shopGoodsInfo.address&&shopGoodsInfo.address.id==null" class="addName">新建收货地址</div>
                      ...
                      <div class="item" v-for="(i,index) in shopGoodsList" :key='index'>
                         <div class="shopName lineBottom" >
                          ...
                          <div  v-for="(item,indexIn) in i.goods" :key='indexIn'
                           @click="$router.push({ path:'/pages/goodsDetail/index',query: { id: item.id }})"
                          >
                             <GoodsDetail  
                            :goodsImg='item.thumb'
                        ...
                        <div class="offSaleCard h40 lineBottom mt20 mb10"
                          @click="$router.push({ path:'/pages/voucher/voucher'})"
                        >
                    ...
                    <div class="submit h50 bgcfff lineTop">
                        <div class="actPay fl">
      ...
      if(this.$route.query.from){
        this.$http.createOrder(...arr).then(
         ...
         this.shopGoodsList = data.goods
          ...
          if(this.shopGoodsInfo.discountprice){
            this.exaHeight+=40
          }
          if(this.shopGoodsInfo.isdiscountprice){
            this.exaHeight+=40
          }
          if(this.shopGoodsInfo.enoughmoney){
            this.exaHeight+=40
          }
          if(this.shopGoodsInfo.merch_enoughmoney){
            this.exaHeight+=40
          }
         this.winHeight = this.shopGoodsList?this.shopGoodsList.length*(this.shopGoodsList[0].goods.length*104 +40) +340 +this.exaHeight:0
